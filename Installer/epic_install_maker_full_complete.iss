[Setup]
UseSetupLdr=true
OutputBaseFilename=unstable_space_beta
OutputDir=C:\Documents and Settings\Administrator\Desktop
AppCopyright=Epic Team
AppName=Unstable Space Beta
AppVerName=Unstable Space Beta 11.7
...
VersionInfoVersion=11.7
VersionInfoTextVersion=Epic 11.7
UsePreviousAppDir=false
WizardImageFile=.\unstable_space_install_left.bmp
...
Source: .\..\EpicArt\High Resolution Nebula\models\farnorth\*; DestDir: {app}\mods\MS_Mod_Main\models\farnorth; Flags: skipifsourcedoesntexist
...
Source: .\..\EpicSource\MS_Mod_Ships\avatars\temp_cargopod\*; DestDir: {app}\mods\MS_Mod_Ships\avatars\temp_cargopod
Source: .\..\EpicSource\MS_Mod_Ships\avatars\freightpod\*; DestDir: {app}\mods\MS_Mod_Ships\avatars\freightpod
...
Source: .\..\EpicSource\MS_Mod_Ships\sims\ships\player\auxiliary_data\*; DestDir: {app}\mods\MS_Mod_Ships\sims\ships\player\auxiliary_data; Flags: skipifsourcedoesntexist
Source: .\..\EpicSource\MS_Mod_Ships\sims\ships\player\capsule_ships\*; DestDir: {app}\mods\MS_Mod_Ships\sims\ships\player\capsule_ships; Flags: skipifsourcedoesntexist
...
Source: .\..\EpicSource\MS_Mod_ClusterModels\images\gui\*.*; DestDir: {app}\resource\images\gui; Flags: skipifsourcedoesntexist
;Source: .\..\EpicSource\docs\unstable_space_bugs.xls; DestDir: {app}\epic_docs; Flags: skipifsourcedoesntexist
Source: .\unstable_space_icon.ico; DestDir: {app}
...
[Icons]
Name: {userdesktop}\Torn Stars; Filename: {app}\IW2EoCGS.exe; WorkingDir: {app}; IconFilename: {app}\unstable_space_icon.ico; Comment: EoC Launcher for Torn Stars; IconIndex: 0
