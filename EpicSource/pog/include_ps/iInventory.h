...
//
// $Header: c:/epic/cvs/EpicSource/pog/include_ps/iInventory.h,v 1.1.1.1 2005/05/13 09:27:23 Owner Exp $
//
...
//
prototype iInventory.Add( int cargo_type, int quantity );
...
//
prototype iInventory.AddWithoutMarkingNew( int cargo_type, int quantity );
...
//
prototype iInventory.SetBlueprintsForCargo( int cargo_type, int blueprints );
...
//
prototype int iInventory.NumberOfCargoInCategory( int category );
...
//
prototype int iInventory.NumberOfCargoInSuperSet( int super_set );
...
//
prototype bool iInventory.IsPieceOfAmmo( int cargo_type );
