...
//
// $Header: c:/epic/cvs/EpicSource/pog/include_ps/iDeathScript.h,v 1.1.1.1 2005/05/13 09:27:23 Owner Exp $
//
...
prototype task iDeathScript.CriticalGroupDeath( hsim sim );
